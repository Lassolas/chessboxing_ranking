export const i18n = {
  en: {
    ...
    matchmaking_rules: "<b>Selectionable:</b> Max boxing diff 2. Win probability 10% – 90%.<br><b>Strict:</b> Max boxing diff 1. Win probability 30% – 70%.",
    off: "Off",
    even: "50 % (even)",
  ...
  fr: {
    ...
    matchmaking_rules: "<b>Sélectionnables :</b> Différence de boxe max 2. Probabilité de victoire 10% – 90%.<br><b>Strict :</b> Différence de boxe max 1. Probabilité de victoire 30% – 70%.",
    off: "Désactivé",
    even: "50 % (égal)",
