...
export const i18n = {
  en: {
    ...
    rule_strict: `<b>Strict:</b> Max boxing diff ${MATCHMAKING_CONSTRAINTS.strict.boxDiffMax}. Win prob ${MATCHMAKING_CONSTRAINTS.strict.minWinProb * 100}%–${MATCHMAKING_CONSTRAINTS.strict.maxWinProb * 100}%.`,
    rule_early_stoppage: `<b>Early Stoppage:</b> Expected rounds < format minimum.`,
    off: "Off",
    even: "50 % (even)",
  ...
  fr: {
    ...
    rule_strict: `<b>Strict :</b> Diff. boxe max ${MATCHMAKING_CONSTRAINTS.strict.boxDiffMax}. Victoire ${MATCHMAKING_CONSTRAINTS.strict.minWinProb * 100}%–${MATCHMAKING_CONSTRAINTS.strict.maxWinProb * 100}%.`,
    rule_early_stoppage: `<b>Arrêt Précoce :</b> Rounds attendus < minimum du format.`,
    off: "Désactivé",
    even: "50 % (égal)",
