export const i18n = {
  en: {
    ...
    matchmaking_rules: "<b>Selectionable:</b> Max boxing diff 2. Win prob ≤ 50%.<br><b>Strict:</b> Max boxing diff 1. Win prob 30%–70%. Exp. length ≥ 4.0 rnds.",
    off: "Off",
    even: "50 % (even)",
  ...
  fr: {
    ...
    matchmaking_rules: "<b>Sélectionnables :</b> Diff. boxe max 2. Victoire ≤ 50%.<br><b>Strict :</b> Diff. boxe max 1. Victoire 30%–70%. Durée estimée ≥ 4.0 rnds.",
    off: "Désactivé",
    even: "50 % (égal)",
